...
- **Sidecar runtime contract** ✓ (2026-05-04) — `design/TAURI_SIDECAR.md` written. Defines entry point, health check, lifecycle states, IPC model, process termination (per-OS), path layout (`DATA_ROOT` platform dirs + `SENNI_DATA_ROOT` override), error states, and implementation checklist for both Python sidecar and Tauri shell.
